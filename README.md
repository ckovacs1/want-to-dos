...
**We have set the test accounts to be following each other and invited the test account to a wanttodo using another account in order to show the past notifications for both follow and invite notifications. (We created a wanttoodo of reading a book with the repetition of 2 times on a daily basis for Dec 16th and Dec 17th)**
